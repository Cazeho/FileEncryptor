...
<i class="fa  fa-fw bg-warning"><img src="https://mootse.telecom-st-etienne.fr/theme/image.php/academi/core/1573633305/u/f2"></img></i>
...
<br>
<br>
<button style="color: black;" class="cote" id="go">Recharger</button>
<button style="color: black;" class="cote1" onclick="myFunction()">Modifier</button>

<div id="myDIV" style="display: none">
<center><form action="/compte.py" method="post">
    <br>
    <br>
  <label style="color: black;" for="fname">User:</label><br>
  <input style="color: black;" type="text" id="fname" name="pseudo"><br>


  <br>
  <label  style="color: black;" for="country">Choisir un pays</label>
  <br>
  <select  style="color: black;" name="country" id="country">
...
co=str(form.getvalue("country"))
#print(k)
#print(k[0])
#print(len(k))

#############
print("""<br>"""+"uuid: "+subprocess.check_output('wmic csproduct get uuid').decode().split('\n')[1].strip())
with open('country.txt', 'r+') as f:
    print("Country: "+f.read()+"""<br>""")
data_email=[]
with open("authmail.txt", 'r') as f:
   for line in f:
       data_email.append(line)

print("Email: "+data_email[0])
uform2="""
...
if co!="None":
    ...
    with open('country.txt', 'r+') as f:
        file_source = f.read()
        file_source=re.sub(k[0], str(co), file_source)
        f.seek(0)
        f.write(file_source)
        f.truncate()
